...
public class BattleSystem : MonoBehaviour
{
    ...
    PokemonPartyMain playerParty;
    Pokemon wildPokemon;
    public void StartBattle(PokemonPartyMain playerParty, Pokemon wildPokemon)
    {
        this.playerParty = playerParty;
        this.wildPokemon = wildPokemon;
        StartCoroutine(SetupBattle());

        FindObjectOfType<PokemonDisplay>().ShowUI(false);
    }
    ...
    public IEnumerator SetupBattle()
    {
        ...
        if (playerUnit == null)
        {
            Debug.LogError("NO PLAYER POKEMON!");
            yield break;
        }

        if (wildPokemon == null)
        {
            Debug.LogError("WILD POKEMON IS NULL!");
            yield break;
        }
    ...
    void BattleOver(bool won)
    {
        ...
        OnBattleOver(won);
        FindObjectOfType<PokemonDisplay>().ShowUI(true);
    }
